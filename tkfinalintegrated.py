...
class VideoPlayer(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.parent = parent
        self.video_canvas = tk.Canvas(self, bg="black", width=300, height=300)
...
def create_results_page(notebook, bg_color):
    ...
    label_results = tk.Label(results_page, text="Final Results Page", font=("Helvetica", 18), bg="black", fg="black")
    ...
    video_player1 = VideoPlayer(results_page)
    video_player1.place(relx=0.35,rely=0.5,anchor=tk.CENTER)    
    video_player = VideoPlayer(results_page)
    video_player.place(relx=0.65,rely=0.5,anchor=tk.CENTER)
    return results_page
